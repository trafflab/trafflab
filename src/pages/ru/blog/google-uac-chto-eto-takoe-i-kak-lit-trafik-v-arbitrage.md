...
1. Введение в Google UAC
2. Вертикали и офферы для Google UAC: где лить трафик?
3. Как работает Google UAC: площадки, креативы, бюджеты
4. Частые ошибки при работе с UAC: краткий ликбез
5. Заключение: Google UAC — ваш путь к мобильному миру
