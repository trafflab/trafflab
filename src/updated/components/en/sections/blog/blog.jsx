	...
	return (
		<section id='blog' className={styles.blog}>
			<SectionContentLayout
				...
				text='Current news, recommendations for traffic, manuals, insider information from closed sources of affiliate marketing. Read the TraffLab blog and stay up to date with all market events.'
			...
			<div className={styles.buttonContainer}>
				<Link to='blog'>
					<BasicButton text='More articles!' handler={() => false} />
				</Link>
			</div>

			<ArticlePopup
				data={articleData}
				isOpen={articlePopupOpen}
				closeHandler={closeArticlePopup}
			/>
		</section>
	);
}
