...
const prosData = [
  ...
  },
  {
    ...
    about: [
      ...
      'Защищает срезанный траф перед рекламодателями'
    ]
  }
]
  ...
  return (
    <section id='pro' className={styles.pro}>
      <SectionContentLayout
        titleSecondPart='PRO'
        text='Trafflab - международная компания. В команде профессионалы в сфере iGaming и EDTech с 7+ летним опытом. Базируемся в странах СНГ, Европе и в некоторых странах Азии. У нас нет предпочтений по национальному, гражданскому или гендерному признаку. Мы говорим на разных языках, в разных странах, но строим взаимодействие со всеми партнерами по единому принципу: win-win.'
